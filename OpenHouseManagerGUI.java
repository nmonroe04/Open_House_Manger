...
public class OpenHouseManagerGUI extends JFrame {
    ...
    private static class KioskPanel extends JPanel {
        ...
        public KioskPanel(OpenHouseManagerGUI parent) {
            ...
            JButton infoButton = createSecondaryButton("Visitors Information Page");
            infoButton.addActionListener(e -> openVisitorHouseBrowser());
        ...
        private void handleCheckIn() {
            ...
            for (Visitor existing : event.getVisitors()) {
            ...
            for (Person p : people) {
                if (p instanceof Agent) {
                    ...
                    for (House h : houses) {
                        ...
                        housesWithEvents.add(h);
                    }
                }
            }

            if (housesWithEvents.isEmpty()) {
                messageArea.setText("No properties with events are available to display.");
                return;
            }

            java.util.List<House> houseList = new ArrayList<>(housesWithEvents);
            VisitorHouseBrowserFrame frame = new VisitorHouseBrowserFrame(parent, houseList);
     ...
     * and return it as a String. System.out is restored afterwards.
     */
